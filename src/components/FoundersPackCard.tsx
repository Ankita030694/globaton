        ...
        <>
            ...
            >
                ...
                <div className="p-8 pb-4 flex justify-between items-center relative z-20">
                    <div></div>
                    <div className="px-3 py-1 text-[10px] font-black uppercase tracking-tighter rounded-full border transition-colors bg-amber-50 text-[#CBA135] border-amber-100">
                        Most Popular
                    </div>
                </div>
